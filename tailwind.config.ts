  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 10px hsl(5 87% 53% / 0.3)" },
          "50%": { boxShadow: "0 0 30px hsl(5 87% 53% / 0.6)" },
        },
        "spin-slow": { from: { transform: "rotate(0deg)" }, to: { transform: "rotate(360deg)" } },
        "ping-once": { "0%": { transform: "scale(1)", opacity: "1" }, "100%": { transform: "scale(1.8)", opacity: "0" } },
      },
      animation: {
